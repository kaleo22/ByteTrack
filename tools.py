...
def count(online_targets, track_id, bounding_box):
    # Count the number of targets
    if track_id not in online_targets:
        online_targets[track_id] = []
    online_targets[track_id].append(bounding_box)

    # Return the count of targets
    return len(online_targets[track_id]) 
